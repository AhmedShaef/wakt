...
import (
	...
	"github.com/AhmedShaef/wakt/app/services/metrics/collector"
	"github.com/AhmedShaef/wakt/app/services/metrics/publisher"
	expvarsrv "github.com/AhmedShaef/wakt/app/services/metrics/publisher/expvar"
	"github.com/AhmedShaef/wakt/foundation/logger"
...
func run(log *zap.SugaredLogger) error {
	...
	cfg := struct {
		...
		Version: conf.Version{
			Build: build,
			Desc:  "Ahmed Shaef's Metrics Service",
		},
	}
	...
	collect, err := collector.New(cfg.Collect.From)
	if err != nil {
	...
	publish, err := publisher.New(log, collect, cfg.Publish.Interval, exp.Publish, stdout.Publish)
	if err != nil {
